...
fun formatConstArrays(inputLevels: Int, gamma: Array<DoubleProperty>, maxOutputLevel: Array<IntegerProperty>, values: Array<List<XYChart.Data<String, Number>>>): String {
    ...
    sb.append(printArduinoCode("gammaR", values[R]))
    sb.append(printArduinoCode("gammaG", values[G]))
    sb.append(printArduinoCode("gammaB", values[B]))
    return sb.toString()
}


fun printArduinoCode(varName: String, values: List<XYChart.Data<String, Number>>): String {
    val sb = StringBuilder()
